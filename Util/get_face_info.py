...
try:
    from Util.util import transform,trans_points2d,trans_points3d,writejson,readjson
except:
    from util import transform,trans_points2d,trans_points3d,writejson,readjson
import math
...
class get_face_info:
    def __init__(self,path,bInsightFaceLocal) -> None:
        ...
        if bInsightFaceLocal:
            ...
            try:
                from utils.http_interface import insightFaceInterface
            except:
